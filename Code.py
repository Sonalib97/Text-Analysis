...
df = pd.read_excel('C:\\Users\\ASUS\\Downloads\\cik_list.xlsx')
df.head()
...
with open('C:\\Users\\ASUS\\Desktop\DAY TRADING\\StopWords_Generic.txt','r') as f:
    stop_words = f.read()
...
master_dic = pd.read_excel('C:\\Users\\ASUS\\Downloads\\LoughranMcDonald_MasterDictionary_2018.xlsx')
master_dic.head()
...
uncertainity = pd.read_excel('C:\\Users\ASUS\\Downloads\\uncertainty_dictionary.xlsx')
uncertainity_words = list(uncertainity['Word'])

constraining = pd.read_excel('C:\\Users\\ASUS\\Downloads\\constraining_dictionary.xlsx')
...
df.to_excel('C:\\Users\\ASUS\\Downloads\\output.xlsx')
